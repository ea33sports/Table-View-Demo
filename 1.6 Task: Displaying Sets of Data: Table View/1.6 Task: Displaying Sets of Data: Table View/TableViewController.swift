...
//
//  Created by Eric Andersen on 3/20/18.
...
class TableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 1...12 {
            if i > 9 {
                items.append(DataItem(title: "Recruit #\(i)", subtitle: "This is subtitle #\(i)", imageName: "img\(i).jpg"))
            } else {
                items.append(DataItem(title: "Rectuit #0\(i)", subtitle: "This is subtitle #0\(i)", imageName: "img0\(i).jpg"))
            }
        }
        for i in 1...12 {
            if i > 9 {
                otherItems.append(DataItem(title: "Another Recruit #\(i)", subtitle: "This is another subtitle #\(i)", imageName: "anim\(i).jpg"))
            } else {
                otherItems.append(DataItem(title: "Another Recruit #0\(i)", subtitle: "This is another subtitle #0\(i)", imageName: "anim0\(i).jpg"))
            }
        }
...
extension TableViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row >= allItems[indexPath.section].count && isEditing {
            cell.textLabel?.text = "Add New Recruit"
