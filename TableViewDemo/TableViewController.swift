...
class TableViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for i in 1...12 {
            if i > 9 {
                items.append(DataItem(title: "Title #\(i)", subtitle: "This is subtitle #\(i)", imageName: "/Users/ericandersen/Desktop/Career Foundry/TableViewDemo/images/img\(i).jpg"))
            } else {
                items.append(DataItem(title: "Title #0\(i)", subtitle: "This is subtitle #0\(i)", imageName: "/Users/ericandersen/Desktop/Career Foundry/TableViewDemo/images/img0\(i).jpg"))
            }
        }
        for i in 1...12 {
            if i > 9 {
                otherItems.append(DataItem(title: "Another Title #\(i)", subtitle: "This is another subtitle #\(i)", imageName: "/Users/ericandersen/Desktop/Career Foundry/TableViewDemo/images/anim\(i).jpg"))
            } else {
                otherItems.append(DataItem(title: "Another Title #0\(i)", subtitle: "This is another subtitle #0\(i)", imageName: "/Users/ericandersen/Desktop/Career Foundry/TableViewDemo/images/anim0\(i).jpg"))
            }
        }
